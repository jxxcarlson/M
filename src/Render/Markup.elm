...
import Render.Settings exposing (Settings)x
import Tree exposing (Tree)


renderFromString : Int -> Accumulator -> Settings -> String -> List (Element MarkupMsg)
renderFromString  count acc settings str =
    -- TODO: is count the right thing to pass here?
    str |> M.ExpressionParser.parse count |> renderFromAST count acc settings
